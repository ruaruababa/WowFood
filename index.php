  ...
  <body>
    ...
    <article>
      <div class="container-article">
        ...
        <div class="footer-food-menu">
          <a href="#" class="see-all-foods">See All Foods</a>
        </div>
      </div>
    </article>
    <footer>
      <div class="container-footer">
        ...
        <div class="license">
          <p>
            All rights reversed. Designed by <a href="">Nguyễn Ngọc Giang</a>
          </p>
        </div>
      </div>
    </footer>
